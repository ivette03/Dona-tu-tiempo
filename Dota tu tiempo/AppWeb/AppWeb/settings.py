...
SECRET_KEY = 'django-insecure-wyc90mag&fg3r4p3+6-wxbm_ha6z8c(-74br=fz&sk+ox)pge!'
...
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': 'root',
        'HOST': 'localhost',  # Puede ser una dirección IP o un dominio
...
AUTHENTICATION_BACKENDS = [
    'aplicacion.views.UserModelBackend',
]
